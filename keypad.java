...
class key{
    ...
    sortByKey(HashMap<Character, Integer> hm)
    {
        ...
        Collections.sort(
            list,
            (i2, i1) -> i1.getValue().compareTo(i2.getValue()));
    ...
    public static void main(String [] args){
        ...
        String s=sc.next();
            ...
            HashMap<Character, Integer> hm1 = sortByKey(h);
            
                int c=0;
           for(Map.Entry<Character,Integer>h1:hm1.entrySet()){
               if(c1<9){
               ...
               c1=c1+1;
               //System.out.println(h1.getKey()+" "+h1.getValue()+" "+c1+" "+c2+" "+c);
           }
